...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=x95castle1&repo=friday-java-web-app",
  "buildTool" : "maven",
  "ide" : "intellij",
  "includeBuildToolWrapper" : true,
  "javaVersion" : "11",
  "nativeBuild" : false,
  "projectName" : "friday-java-web-app",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->friday-java-web-app]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [: tanzu-java-web-app->: friday-java-web-ap...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=x95castle1&repo=friday-java-web-app'
